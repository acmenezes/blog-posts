...
With this blog post I intend to update some of the content I previously worked on about [Security Context Constraints](https://cloud.redhat.com/blog/introduction-to-security-contexts-and-sccs) and [Linux Capabilities](https://cloud.redhat.com/blog/managing-sccs-in-openshift) in OpenShift given the latest pod security standards implementation in Kubernetes and important improvements implemented from OpenShift 4.11 and beyond on SCCs. I will also use this opportunity to share some of the most important links and docs in a single place for those interested in the subject.
